...
export const RETIRED_COURTS: RetiredCourt[] = [
  ...
  {
    address: "0x219e753176D1157bC22376e10d06e4E21E401417".toLowerCase(),
    label: "Legacy docket",
    cutoffMs: Date.parse("2026-08-26T19:00:00.000Z"),
  },
  {
    address: "0x1b8Fc1a2B16352228f2016DB1BBbeAaBA9192B37".toLowerCase(),
    label: "Legacy docket",
    cutoffMs: Date.parse("2026-08-27T06:10:00.000Z"),
  },
];
...
export const CURRENT_COURT_CUTOFF_MS = Date.parse("2026-08-27T12:20:00.000Z");
